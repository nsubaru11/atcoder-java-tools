...
Java 提出の補助（Compiler APIによるMain/DEBUG/library変換、折りたたみ、ショートカット）。LocalRunner不在時のみsharedの字句変換へフォールバックします。
...
| JavaCodeSubmitter               | LocalRunner `transform` API、フォールバック変換、設定 JSON |

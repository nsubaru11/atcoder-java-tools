...
Java 提出の補助（Compiler APIによるMain/DEBUG/library変換、折りたたみ、ショートカット）。LocalRunnerへ接続できない場合は部分変換せず、画面にエラーを表示します。
...
| JavaCodeSubmitter               | LocalRunner `transform` API、設定 JSON |
